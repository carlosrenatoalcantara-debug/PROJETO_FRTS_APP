...
/**
 * EtapaEngenharia — fase paralela — FV-API-001.
 *
 ...
 */
export default function EtapaEngenharia() {
  const { lista, carregando, erro } = useFases()
  const fase = lista.find((f) => f.chave === 'engenharia')
  ...
  return (
    <section className="mx-auto max-w-2xl p-6">
      <h2 className="text-lg font-semibold text-slate-900">Engenharia</h2>
